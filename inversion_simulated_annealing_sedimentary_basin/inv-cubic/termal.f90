SUBROUTINE termal(xm,ym,x0,y0,z0,z1,z,fx,temperatura,func,naccepted,idum,g_campo,nsteps,p1,q1,r1,s1,g_calc)
IMPLICIT NONE
  ...
  REAL(KIND=8), INTENT(IN) :: temperatura,z0,z1
...
!  REAL(KIND=8), INTENT(IN), DIMENSION(:) :: ym ! m-1 posições de centros dos prismas (eixo y) 
  ...
  REAL(KIND=8), PARAMETER :: e=0.15   ! Escala escolhida para FUNC específica
...
a=nsteps/10 ! número de aceitação de passos ruins!
